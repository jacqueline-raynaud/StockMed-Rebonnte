...
## Etat de l'application à la reprise
...
Trois sources différentes et parfois deux descriptions du même défaut.

### Audit technique

Réalisé par un prestataire externe, avec un angle **green code** et maintenabilité.
...
Certaines actions apparaissent de façon sporadique, d'autres sont  
...
| Accessibilité (TalkBack, contrastes) | T-31 | **En cours** |
